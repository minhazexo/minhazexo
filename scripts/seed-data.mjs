...
async function seed() {
  ...
  if (existingProjects.length === 0) {
    const projects = [
      { title: 'GeoWeather', description: 'Real-time weather dashboard with location-based forecasts, interactive maps, and severe weather alerts.', image: '/Project%20Photo/project-weather.webp', tech: ['React', 'API Integration', 'Chart.js', 'PWA', 'Geolocation'], category: 'React', github: 'https://github.com/minhazexo/weather-app', demo: 'https://minhazexo.github.io/weather-app/' },
      ...
      { title: 'Seecto Bangladesh', description: 'A youth-led climate justice organization platform championing sustainability, energy transition, and environmental advocacy across Bangladesh.', image: '/Project%20Photo/project-seecto-bangladesh.webp', tech: ['React', 'Tailwind', 'CSS'], category: 'React', github: 'https://github.com/minhazexo', demo: 'https://minhazexo.github.io/seecto-bangladesh/' },
