    ...
    >
      ...
      <div className="relative w-40 h-40 mb-8">
        <motion.div
          ...
          style={{ boxShadow: '0 0 60px rgba(0, 212, 255, 0.4), 0 0 100px rgba(0, 212, 255, 0.2)' }}
        ...
        <motion.div
          ...
          animate={{ boxShadow: '0 0 30px rgba(0, 212, 255, 0.6), 0 0 60px rgba(255, 0, 170, 0.4)' }}
        >
          <motion.div 
            className="w-10 h-10 rounded-full border-t-2 border-b-2 border-white"
            animate={{ rotate: 360 }}
        ...
        {[0, 120, 240].map((angle, i) => (
          <motion.div
            ...
            style={{ top: '50%', left: '50%', marginTop: -4, marginLeft: -4, boxShadow: '0 0 10px #00D4FF' }}
            animate={{
              rotate: 360,
      ...
      >
        <p className="text-cyan-400 font-orbitron tracking-[0.3em] text-sm mb-3">
          SYSTEM COMPILING...
        </p>
